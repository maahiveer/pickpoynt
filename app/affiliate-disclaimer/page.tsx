            ...
            <article className="bg-white dark:bg-slate-800 rounded-2xl shadow-lg p-8 sm:p-12">
              ...
              <div className="prose prose-lg max-w-none dark:prose-invert">
                ...
                <ul className="list-disc pl-6 mb-4">
                  ...
                  <li>Garden tool and gear retailers</li>
                  <li>Seed and plant providers</li>
                  <li>Soil and nutrient resources</li>
                  <li>Greenhouse and irrigation systems</li>
                  <li>Organic gardening resources</li>
                  <li>Landscape design tools</li>
                </ul>
                ...
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6 mt-8">
                  ...
                  <p className="text-blue-700 dark:text-blue-300">
                    ...
                    you're helping us continue to provide valuable content and resources to the gardening
